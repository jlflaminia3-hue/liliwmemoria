<style>
  ...
  .liliw-footer-brand p {
    max-width: 430px;
  }

  .liliw-footer-links ul {
    display: grid;
    gap: 12px;
  }

  .liliw-footer-subscribe .lonyo-subscription-field2 form {
    display: flex;
    flex-direction: column;
    gap: 14px;
  }

  .liliw-footer-subscribe input[type="email"] {
    width: 100%;
  }
...
<footer class="lonyo-footer-section light-bg">
  <div class="container">
    <div class="lonyo-footer-one">
      <div class="row liliw-footer-grid justify-content-between">
        <div class="col-xl-5 col-lg-5 col-md-12">
          <div class="lonyo-footer-textarea liliw-footer-brand">
            ...
            <div class="lonyo-social-wrap">
              <ul>
                <li>
                  <a href="https://www.facebook.com/memorialparkofsansebastian">
                    <svg width="10" height="18" viewBox="0 0 9 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M2.61987 16.7464V9.37041H0.137695V6.49583H2.61987V4.37591C2.61987 1.91577 4.12245 0.576172 6.31707 0.576172C7.36832 0.576172 8.27181 0.654439 8.53511 0.689422V3.26042L7.01302 3.26111C5.81946 3.26111 5.58836 3.82827 5.58836 4.66054V6.49583H8.43488L8.06426 9.37041H5.58836V16.7464H2.61987Z" fill="#142C14" />
                    </svg>
                  </a>
                </li>
                <li>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="lonyo-footer-menu mb-0 liliw-footer-subscribe">
            <h4>Stay Informed</h4>
