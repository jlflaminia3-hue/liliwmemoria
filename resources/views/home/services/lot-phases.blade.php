      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="liliwmemoria-page-hero__content text-center" data-aos="fade-up" data-aos-duration="700">
            ...
            <h1 class="liliwmemoria-page-hero__title">LOT PHASES</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row g-5 justify-content-center">
        <div class="col-lg-7" data-aos="fade-up" data-aos-duration="700">
          <figure class="liliwmemoria-service-detail__media">
            <img
              src="{{ asset('frontend/assets/images/service/lot-phases.jpg') }}"
              alt="Lot Phases - Different phases of lot development and availability at Liliw Memoria"
              class="liliwmemoria-service-detail__img"
              loading="lazy"
            >
            <figcaption class="liliwmemoria-service-detail__img-caption">Lot Phases - Multiple development phases with various lot options</figcaption>
          </figure>
        </div>
        ...
        <div class="col-lg-5" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__content">
            ...
            <h2 class="liliwmemoria-service-detail__title">LOT PHASES</h2>
            <p class="liliwmemoria-service-detail__text">
              Our Lot Phases are thoughtfully developed sections of the memorial park, offering families 
              accessible options at lower prices without compromising care and quality. 
              As our most popular choice, these lots provide a dignified resting place that balances affordability with serene surroundings.
            </p>
        ...
        <div class="col-12" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__form-wrapper">
            ...
            <form method="POST" action="{{ route('contact.inquiry.submit') }}" class="liliwmemoria-service-detail__form-inner">
              ...
              <input type="hidden" name="subject" value="LOT PHASES">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  <p class="form-text">Subject will be sent as <strong>LOT PHASES</strong>.</p>
                </div>
              </div>
