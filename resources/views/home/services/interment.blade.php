      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="liliwmemoria-page-hero__content text-center" data-aos="fade-up" data-aos-duration="700">
            ...
            <h1 class="liliwmemoria-page-hero__title">INTERMENT</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row g-5 justify-content-center">
        <div class="col-lg-7" data-aos="fade-up" data-aos-duration="700">
          <figure class="liliwmemoria-service-detail__media">
            <img
              src="{{ asset('frontend/assets/images/service/interment.jpg') }}"
              alt="Interment Services - Professional assistance with scheduling, coordination, and dignified service at Liliw Memoria"
              class="liliwmemoria-service-detail__img"
              loading="lazy"
            >
            <figcaption class="liliwmemoria-service-detail__img-caption">Interment Service - Professional guidance and coordination for dignified ceremonies</figcaption>
          </figure>
        </div>
        ...
        <div class="col-lg-5" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__content">
            ...
            <h2 class="liliwmemoria-service-detail__title">INTERMENT</h2>
              <p class="liliwmemoria-service-detail__text">
                Our services ensure compliance with municipal health and safety protocols, 
                while providing families with a respectful and compassionate ceremony.           
              </p>
            <p class="liliwmemoria-service-detail__text">We assist families through the interment process with clear guidance, scheduling support, and on-site coordination to ensure a dignified service.</p>
        ...
        <div class="col-12" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__form-wrapper">
            ...
            <form method="POST" action="{{ route('contact.inquiry.submit') }}" class="liliwmemoria-service-detail__form-inner">
              ...
              <input type="hidden" name="subject" value="INTERMENT">
              <input type="hidden" name="reason" value="interment">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  <p class="form-text">Subject will be sent as <strong>INTERMENT</strong>.</p>
                </div>
              </div>
