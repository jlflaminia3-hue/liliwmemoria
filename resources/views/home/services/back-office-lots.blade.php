      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="liliwmemoria-page-hero__content text-center" data-aos="fade-up" data-aos-duration="700">
            ...
            <h1 class="liliwmemoria-page-hero__title">BACK OFFICE LOTS</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row g-5 justify-content-center">
        <div class="col-lg-7" data-aos="fade-up" data-aos-duration="700">
          <figure class="liliwmemoria-service-detail__media">
            <img
              src="{{ asset('frontend/assets/images/service/backoffice2.jpg') }}"
              alt="Back Office Lots - Convenient lot option with easy access near service areas at Liliw Memoria"
              class="liliwmemoria-service-detail__img"
              loading="lazy"
            >
            <figcaption class="liliwmemoria-service-detail__img-caption">Back Office Lot - Practical memorial option with convenient access</figcaption>
          </figure>
        </div>
        ...
        <div class="col-lg-5" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__content">
            ...
            <h2 class="liliwmemoria-service-detail__title">BACK OFFICE LOTS</h2>
            <p class="liliwmemoria-service-detail__text">Back Office Lots provide a practical memorial option with convenient access and a peaceful, well‑maintained setting. 
              Designed for families seeking affordability without compromising dignity, these lots balance accessibility with compassionate care.</p>

            <p class="liliwmemoria-service-detail__text">Back Office Lots provide a practical option with convenient access while still offering a peaceful, well-maintained memorial setting.</p>
        ...
        <div class="col-12" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__form-wrapper">
            ...
            <form method="POST" action="{{ route('contact.inquiry.submit') }}" class="liliwmemoria-service-detail__form-inner">
              ...
              <input type="hidden" name="subject" value="BACK OFFICE LOTS">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  <p class="form-text">Subject will be sent as <strong>BACK OFFICE LOTS</strong>.</p>
                </div>
              </div>
