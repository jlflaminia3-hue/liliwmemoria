      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="liliwmemoria-page-hero__content text-center" data-aos="fade-up" data-aos-duration="700">
            ...
            <h1 class="liliwmemoria-page-hero__title">GARDEN LOTS</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row g-5 justify-content-center">
        <div class="col-lg-7" data-aos="fade-up" data-aos-duration="700">
          <figure class="liliwmemoria-service-detail__media">
            <img
              ...
              alt="Garden Lots - Peaceful garden setting with landscaped environment for quiet reflection at Liliw Memoria"
              class="liliwmemoria-service-detail__img"
              loading="lazy"
            >
            <figcaption class="liliwmemoria-service-detail__img-caption">Garden Lot - Calm landscaped environment ideal for family visits</figcaption>
          </figure>
        </div>
        ...
        <div class="col-lg-5" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__content">
            ...
            <h2 class="liliwmemoria-service-detail__title">GARDEN LOTS</h2>

            <p class="liliwmemoria-service-detail__text">
            Distinctive elevated memorial lots, crafted with premium finishes such as marble or tile. 
            These lots provide a dignified presence and enhanced protection, ideal for families seeking a prestigious resting place.
            </p>

            <p class="liliwmemoria-service-detail__text">Garden Lots offer a calm, landscaped environment ideal for families who value a serene space for visits, reflection, and ongoing care.</p>
        ...
        <div class="col-12" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__form-wrapper">
            ...
            <form method="POST" action="{{ route('contact.inquiry.submit') }}" class="liliwmemoria-service-detail__form-inner">
              ...
              <input type="hidden" name="subject" value="GARDEN LOTS">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  <p class="form-text">Subject will be sent as <strong>GARDEN LOTS</strong>.</p>
                </div>
              </div>
              ...
              <div class="liliwmemoria-service-detail__form-note">
                Subject will be sent as <strong>GARDEN LOTS</strong>.
              </div>
            </form>
          </div>
        </div>
