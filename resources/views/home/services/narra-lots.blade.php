      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="liliwmemoria-page-hero__content text-center" data-aos="fade-up" data-aos-duration="700">
            ...
            <h1 class="liliwmemoria-page-hero__title">NARRA LOTS</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row g-5 justify-content-center">
        <div class="col-lg-7" data-aos="fade-up" data-aos-duration="700">
          <figure class="liliwmemoria-service-detail__media">
            <img
              src="{{ asset('frontend/assets/images/service/narra.jpg') }}"
              alt="Narra Lots - A serene and well-kept resting place with dignified layout for family visits at Liliw Memoria"
              class="liliwmemoria-service-detail__img"
              loading="lazy"
            >
            <figcaption class="liliwmemoria-service-detail__img-caption">Narra Lot - Premium memorial space with peaceful garden setting</figcaption>
          </figure>
        </div>
        ...
        <div class="col-lg-5" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__content">
            ...
            <h2 class="liliwmemoria-service-detail__title">NARRA LOTS</h2>

            <p class="liliwmemoria-service-detail__text">
              Narra Lots offer a modern memorial style with sleek glass and metal markers set against landscaped greenery. 
              Designed to balance elegance and simplicity, these lots provide a dignified resting place with a contemporary touch.</p>
            
            <p class="liliwmemoria-service-detail__text">Our Narra Lots are located in a quiet area of the memorial park and maintained regularly to ensure a clean and dignified setting for remembrance.</p>
        ...
        <div class="col-12" data-aos="fade-up" data-aos-duration="700">
          <div class="liliwmemoria-service-detail__form-wrapper">
            ...
            <form method="POST" action="{{ route('contact.inquiry.submit') }}" class="liliwmemoria-service-detail__form-inner">
              ...
              <input type="hidden" name="subject" value="NARRA LOTS">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                  <p class="form-text">Subject will be sent as <strong>NARRA LOTS</strong>.</p>
                </div>
              </div>
