...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset($metaLogoExists ? $metaLogoPath : 'frontend/assets/images/favicon.ico') }}" type="image/x-icon">
  <link rel="icon" href="{{ asset($metaLogoExists ? $metaLogoPath : 'frontend/assets/images/favicon.ico') }}" type="image/x-icon">
  <link rel="apple-touch-icon" href="{{ asset($metaLogoExists ? $metaLogoPath : 'frontend/assets/images/favicon.ico') }}">
  <meta property="og:image" content="{{ asset($metaLogoExists ? $metaLogoPath : 'frontend/assets/images/favicon.ico') }}">
  <meta name="twitter:image" content="{{ asset($metaLogoExists ? $metaLogoPath : 'frontend/assets/images/favicon.ico') }}">
  <!--- End favicon-->
    ...
    <div class="progress-wrap">
      ...
      <div class="top-arrow">
        <svg width="12" height="20" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0.999999 1L8 8L1 15" stroke="#142C14" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      </div>
    </div>
  </div>
