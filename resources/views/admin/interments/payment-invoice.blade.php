            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('admin.interments.show', $deceased) }}" class="btn btn-light">Back</a>
                        <a href="{{ route('admin.interments.payments.invoice', [$deceased, $payment, 'download' => 1]) }}" class="btn btn-light">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="text-muted small">
                                        {{ $deceased->full_name }} ({{ $deceased->lot ? "Lot {$deceased->lot->lot_number}, {$deceased->lot->section}" : 'No lot assigned' }})
                                    </div>
                                </td>
                ...
                @if ($payment->receipt_path)
                    <div class="mt-4 pt-3 border-top">
                        <a href="{{ route('admin.interments.payments.receipt', [$deceased, $payment]) }}" class="btn btn-outline-primary">
